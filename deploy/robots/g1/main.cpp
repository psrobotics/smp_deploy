...
static inline void set_default_env(const char* key, const char* value)
{
...
{
    set_default_env("UNITREE_RT_DASHBOARD", "1");
    set_default_env("UNITREE_RT_DASHBOARD_MS", "250");
    set_default_env("UNITREE_RT_TELEMETRY", "1");
    set_default_env("UNITREE_RT_LOG_EVERY", "500");
    set_default_env("UNITREE_FSM_RT_PRIO", "97");
